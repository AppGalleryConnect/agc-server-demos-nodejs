    ...
    constructor(clientName, region) {
        try {
            ...
            * */
            ...
            agconnect.AGCClient.initialize(agconnect.CredentialParser.toCredential(credentialPath), clientName, region);
            const agcClient = agconnect.AGCClient.getInstance(clientName);
