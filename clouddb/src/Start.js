...
async function start() {
    /**
     * Get a instance of China Region.
     * The parameter name is user-defined.
     * The region parameter is optional. The value range is ["CN", "RU", "SG", "DE"].
     *
     * @type {CloudDBZoneWrapper}
     */
    const cloudDBZoneWrapper = new CloudDBZoneWrapper("clientCN", "CN");
